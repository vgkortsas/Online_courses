...
class Actor:
    ...
    def build_model(self, dropout_rate, learning_rate, model_plot=False):
        ...
        # version 3 : this is what they use in the paper
        ...
        # version 2
        #raw_actions = layers.Dense(units=self.action_size, activation='sigmoid', name='raw_actions',          kernel_initializer=layers.initializers.RandomUniform(minval=-3e-3,maxval=3e-3))(net)
...
class Critic:
    ...
    def build_model(self, dropout_rate, learning_rate, model_plot=False):
        ...
        # version 2
        #Q_values = layers.Dense(units=1, name='q_values',kernel_initializer=layers.initializers.RandomUniform(minval=-3e-3,maxval=3e-3))(net)
        
        # version 3
        #Q_values = layers.Dense(units=1, name='q_values',kernel_regularizer=regularizers.l2(0.01),kernel_initializer=layers.initializers.RandomUniform(minval=-3e-3,maxval=3e-3))(net)
